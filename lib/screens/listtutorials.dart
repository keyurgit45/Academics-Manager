...
class ListTutorials extends StatefulWidget {
  @override
  _ListTutorialsState createState() => _ListTutorialsState();
}

class _ListTutorialsState extends State<ListTutorials> {
  ...
  getSubjects() async {
    ...
    var mygetter = box.get('tutorialskey');

    if (mygetter == null || mygetter.myData.length == 0) {
      isNull = true;
    } else {
      isNull = false;
      myData = box.get('tutorialskey').myData;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.orange,
        title: Text("Tutorials/Practicals"),
      ),
      body: isLoading
          ...
          : isNull == true
              ? Center(
                  child: Text(
                  "Add some data !\nIf your tutorial/practical is completed then tick the CheckBox!",
            ...
            children: <Widget>[
              ...
              Theme(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    border: OutlineInputBorder(),
                    hintText: 'Enter tutorial/practical no.',
                  ),
                  validator: (name) =>
