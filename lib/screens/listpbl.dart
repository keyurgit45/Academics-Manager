...
class ListPBL extends StatefulWidget {
  @override
  _ListPBLState createState() => _ListPBLState();
}

class _ListPBLState extends State<ListPBL> {
  ...
  getSubjects() async {
    ...
    var mygetter = box.get('pblkey');

    if (mygetter == null || mygetter.myData.length == 0) {
      isNull = true;
    } else {
      isNull = false;
      myData = box.get('pblkey').myData;
    ...
    return Scaffold(
      ...
      body: isLoading
          ...
          : isNull == true
              ? Center(
                  child: Text(
                  "Add some data !\nIf your pbl/project is completed then tick the CheckBox!",
